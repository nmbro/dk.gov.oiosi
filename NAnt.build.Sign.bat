...
nant -D:build.number=65534 -D:teamcity.dotnet.nunitlauncher2.0=packages/NUnit.Runners.2.6.4/tools/nunit.exe -D:buildType=Dev -f:build.xml Sign -logfile:NAnt.build.log
