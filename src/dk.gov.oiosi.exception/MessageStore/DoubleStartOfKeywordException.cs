...
{
    /// <summary>
    /// This custom exception is thrown, when the opening bracket '[' is represented twice and therefore
    /// never closed correctly
    /// </summary>
    [Serializable]     
    public class DoubleStartOfKeywordException : Exception
    {
        /// <summary>
        /// This is the default constructor
        /// </summary>
        public DoubleStartOfKeywordException() : base() { }
        
        /// <summary>
        /// This constructor is used when you want to pass a custom message to the calling method
        /// </summary>
        /// <param name="message">the message to forward</param>
        public DoubleStartOfKeywordException(string message) : base(message) { } 
        ...
        public DoubleStartOfKeywordException(string message, Exception innerException) : base(message, innerException) {}
        ...
        protected DoubleStartOfKeywordException(SerializationInfo serializationInfo, StreamingContext streaminContext) : base(serializationInfo, streaminContext) { }
