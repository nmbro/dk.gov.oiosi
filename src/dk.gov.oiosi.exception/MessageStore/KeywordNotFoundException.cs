...
{
    /// <summary>
    /// This custom exception is thrown, when the given keyword is not found
    /// </summary>
    [Serializable]
    public class KeywordNotFoundException : Exception
    {
        ...
        public KeywordNotFoundException(string message, Exception innerException) : base(message, innerException) { }
        ...
        protected KeywordNotFoundException(SerializationInfo serializationInfo, StreamingContext streaminContext) : base(serializationInfo, streaminContext) { }
