...
namespace dk.gov.oiosi.raspProfile {
    ...
    public class DefaultUddiConfig {
        ...
        public void SetDefaultUddiConfig() {
            ...
            uddiConfig.LookupRegistryFallbackConfig.PrioritizedRegistryList.Add(new Registry(new List<string>() { "http://discoverypublic.uddi.ehandel.gov.dk/registry/uddi/inquiry", "http://discovery.uddi.ehandel.gov.dk/registry/uddi/inquiry" }));
            uddiConfig.LookupRegistryFallbackConfig.PrioritizedRegistryList.Add(new Registry(new List<string>() { "http://discoverygateway.uddi.ehandel.gov.dk/UddiAdapterService/2008/10/27/UddiAdapterService.svc", "http://discoverygateway.uddi.ehandel.gov.dk/UddiAdapterService/2008/10/27/UddiAdapterService.svc" }));
        }
