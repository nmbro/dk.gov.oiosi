...
namespace dk.gov.oiosi.raspProfile {
    ...
    public class ProfileMappingCollection {
        ...
        public void AddAll() {
            ...
            AddMapping("Procurement-OrdSelR-BilSimR-1.0", "uddi:34CD4205-D7CF-47f6-87D4-DF4F8DB2AEFD");
            AddMapping("Procurement-OrdSel-BilSimR-1.0", "uddi:42AD3EDE-BBD4-434d-AAE6-044CE3EF8D1F");
            AddMapping("Procurement-OrdSelR-BilSim-1.0", "uddi:ACED2BA9-5B9F-44d6-9698-FB55C3DED1A9");
            ...
            AddMapping("NS OIOXML Elektronisk Regning",	"uddi:367e54f0-a24e-11dc-a80b-bfc65441a808");
            AddMapping("NS OIOXML Elektronisk Kreditnota", "uddi:2c33e6e0-a24e-11dc-a80b-bfc65441a808");
            AddMapping("NS Procurement-BilSimR-1.0", "uddi:47a2e980-a24e-11dc-a80b-bfc65441a808");
            AddMapping("NS Procurement-OrdAdvR-BilSimR-1.0", "uddi:5197bd80-a24e-11dc-a80b-bfc65441a808");
            AddMapping("NS NS Procurement-PayBasR-1.0",	"uddi:4d2dadf0-e05a-11dc-889b-1a827c218899");
            AddMapping("NKS 2.0", "uddi:fbc05a80-bde5-11dc-a81d-bfc65441a808");
            AddMapping("DOIP Order", "uddi:1a967cf0-bde6-11dc-a81d-bfc65441a808");
