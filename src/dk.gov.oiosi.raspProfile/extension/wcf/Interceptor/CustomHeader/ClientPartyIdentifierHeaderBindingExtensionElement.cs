...
{
    /// <summary>
    /// Client party identifier header binding extension element
    /// </summary>
    public class ClientPartyIdentifierHeaderBindingExtensionElement: BindingElementExtensionElement
    {
