...
namespace dk.gov.oiosi.addressing {
    ...
    /// <summary>
    /// Represents a VANS identifier
    /// </summary>
    public class IdentifierVans : Identifier {
        ...
        {
            get { return EndpointKeyTypeCode.vans; }
        }
        ...
        /// Constructor
        /// </summary>
        /// <param name="vansNumber">The VANS identifier</param>
        public IdentifierVans(string vansNumber) {
            Set(vansNumber);
        }
        ...
        public override void Set(string vansNumber) {
            ...
            _vansNumber = vansNumber;
        }

        /// <summary>
        /// Returns the VANS identifier as a string
        /// </summary>
        /// <returns>Returns the VANS identifier</returns>
