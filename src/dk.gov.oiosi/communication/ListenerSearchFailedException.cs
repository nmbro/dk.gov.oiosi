...
namespace dk.gov.oiosi.communication {
    ...
    /// </summary>
    public class ListenerSearchFailedException : RaspCommunicationException {

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="currentServiceHost">The current service host</param>
        public ListenerSearchFailedException(ServiceHostBase currentServiceHost) : base(GetKeywords(currentServiceHost)) { }
