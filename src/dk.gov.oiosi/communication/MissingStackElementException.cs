...
namespace dk.gov.oiosi.communication {
    /// <summary>
    /// Exception thrown when a stack element is missing.
    /// </summary>
    public class MissingStackElementException : OiosiCommunicationException {
        /// <summary>
        /// Exception that takes the missing elements name as parameter.
        /// </summary>
        /// <param name="missingElement"></param>
        public MissingStackElementException(string missingElement) : base(KeywordFromString.GetKeyword("element", missingElement)) { }
        /// <summary>
