...
namespace dk.gov.oiosi.communication {
    ...
    public class OiosiCommunicationException : dk.gov.oiosi.exception.MainException {
        ...
        /// Constructor
        /// </summary>
        public OiosiCommunicationException() : base(resourceManager) { }
        
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="keywords">the keyword for the message</param>
        public OiosiCommunicationException(System.Collections.Generic.Dictionary<string, string> keywords) : base(resourceManager, keywords) { }
        
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="innerException">the innerexception of the thrown message</param>
        public OiosiCommunicationException(System.Exception innerException) : base(resourceManager, innerException) { }
        ...
        /// <param name="innerException">the innerexception of the thrown message</param>
        public OiosiCommunicationException(System.Collections.Generic.Dictionary<string, string> keywords, System.Exception innerException) : base(resourceManager, keywords, innerException) { }
