...
namespace dk.gov.oiosi.communication
{
    ...
    /// </summary>
    public class RaspProtocolMismatchException : RaspCommunicationException {
        
        /// <summary>
        /// Base constructor
        /// </summary>
        public RaspProtocolMismatchException() : base() { }
        
        /// <summary>
        /// Constructor with innerexception
        /// </summary>
        /// <param name="innerException">the innerexception from the thrown exception</param>
        public RaspProtocolMismatchException(System.Exception innerException) : base(innerException) { }
    }
}