...
namespace dk.gov.oiosi.communication {
    ...
    /// <summary>
    /// Listener search exception
    /// </summary>
    public class WcfListenerSearchFailedException : OiosiCommunicationException {

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="currentServiceHost">The current service host</param>
        public WcfListenerSearchFailedException(ServiceHostBase currentServiceHost) : base(GetKeywords(currentServiceHost)) { }
