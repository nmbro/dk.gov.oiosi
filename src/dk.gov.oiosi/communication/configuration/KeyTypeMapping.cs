...
namespace dk.gov.oiosi.communication.configuration {
    ...
    /// </summary>
    [XmlType("Mapping", Namespace = dk.gov.oiosi.configuration.ConfigurationHandler.RaspNamespaceUrl)]
    public class KeyTypeMapping {
        ...
        /// <param name="mapsTo">Value mapping</param>
        public KeyTypeMapping(string value, string mapsTo) {
            _value = value;
            _mapsTo = mapsTo;
        }
