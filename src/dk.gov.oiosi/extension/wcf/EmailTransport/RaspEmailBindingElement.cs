...
namespace dk.gov.oiosi.extension.wcf.EmailTransport 
{
    ...
    /// </summary>
    public class RaspEmailBindingElement : TransportBindingElement {
        ...
        public event dk.gov.oiosi.exception.AsyncExceptionThrownHandler ExceptionThrown;
        ...
        /// Default constructor
        /// </summary>
        public RaspEmailBindingElement() { }
        ...
        internal void RaiseAsyncException(object caller, Exception e) {
            // TODO: This line should be brought back. It has been outcommented to test that
            // our .Clone() hack works
        ...
        public override BindingElement Clone() {
            RaspEmailBindingElement b = new RaspEmailBindingElement();
            b.CopyElement(this);
        ...
        public override IChannelFactory<TChannel> BuildChannelFactory<TChannel>(BindingContext context) {
            ...
            if (typeof(TChannel) != typeof(IRequestChannel)) {
                throw new RaspEmailTransportChannelCouldNotBeBuiltException(typeof(TChannel).ToString());
            }
            else {
                return (IChannelFactory<TChannel>) new RaspEmailChannelFactory(context);
            }
        }
        ...
        public override IChannelListener<TChannel> BuildChannelListener<TChannel>(BindingContext context) {
            ...
            if (typeof(TChannel) != typeof(IReplyChannel)) {
                ...
                return (IChannelListener<TChannel>)new RaspEmailChannelListener(context);
            }
        }
