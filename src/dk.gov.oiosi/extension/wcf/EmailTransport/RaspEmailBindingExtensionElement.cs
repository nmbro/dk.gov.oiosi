...
namespace dk.gov.oiosi.extension.wcf.EmailTransport {
    ...
    /// </summary>
    public class RaspEmailBindingExtensionElement: BindingElementExtensionElement, IRaspEmailBindingElementConfiguration {
        /// <summary>
        ...
        public override Type BindingElementType {
            get { return typeof(RaspEmailBindingElement); }
        }
        ...
        protected override BindingElement CreateBindingElement() {
            return (BindingElement)new RaspEmailBindingElement(this);
        }
    }
}