...
namespace dk.gov.oiosi.extension.wcf.EmailTransport {
    ...
    /// </summary>
    public class RaspEmailChannelFactory: ChannelFactoryBase<IRequestChannel> {
        ...
        /// Constructor
        /// </summary>
        public RaspEmailChannelFactory(BindingContext bindingContext) {
        ...
        void mailHandler_OnExceptionThrown(Exception e, object caller) {
            Fault();
            //TODO: Should we? this.Abort(); Probably not
        }
        ...
        protected override void OnClose(TimeSpan timeout) {
            // TODO:
            //if(_mailHandler != null && _mailHandler.InboxState != InboxState.Faulted) 
            //    _mailHandler.Close();
