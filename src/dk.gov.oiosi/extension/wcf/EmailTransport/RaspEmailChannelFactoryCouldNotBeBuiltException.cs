...
namespace dk.gov.oiosi.extension.wcf.EmailTransport
{
    ...
    /// </summary>
    public class RaspEmailTransportChannelCouldNotBeBuiltException : RaspEmailTransportException {
        
        /// <summary>
        /// Constructor with the channeltype as keyword
        /// </summary>
        /// <param name="channelType">the channeltype as keyword</param>
        public RaspEmailTransportChannelCouldNotBeBuiltException(string channelType) : base(GetKeywords(channelType)) { }
        ...
        public RaspEmailTransportChannelCouldNotBeBuiltException(string channelType, System.Exception innerException) : base(GetKeywords(channelType), innerException) { }
