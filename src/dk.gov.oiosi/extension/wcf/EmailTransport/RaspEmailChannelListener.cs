...
namespace dk.gov.oiosi.extension.wcf.EmailTransport {
    ...
    /// RSAP email listener
    /// </summary>
    public class RaspEmailChannelListener: ChannelListenerBase<IReplyChannel> {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// 
        /// </summary>
        protected RaspMailHandler pMailHandler;
        ...
        public RaspEmailChannelListener(BindingContext context) {
            pContext = context;
        ...
        protected override IReplyChannel OnAcceptChannel(TimeSpan timeout) {
            ...
            if (mail == null) {
                ...
                WCFLogger.Write(System.Diagnostics.TraceEventType.Stop, "Listener finished listening for a mail.");
                return new RaspEmailReplyChannel(this, pMailHandler, mail, pContext.Binding.Elements.Find<RaspEmailBindingElement>());
            }
        }
        ...
        private void CallbackMailExceptionThrown(Exception e, object caller){
            pContext.Binding.Elements.Find<RaspEmailBindingElement>().RaiseAsyncException(this, e);
            //pMailHandler.Close();
            //pMailHandler = null;
            this.Abort();
        }
        ...
        void CallbackOnInboxStateChange(InboxState newState) {
            pContext.Binding.Elements.Find<RaspEmailBindingElement>().InboxStateChange(newState);
        }
