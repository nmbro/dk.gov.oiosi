...
namespace dk.gov.oiosi.extension.wcf.EmailTransport {
    ...
    /// </summary>
    public class RaspEmailRequestChannel : RaspChannelBase, IRequestChannel {
        ...
        public Message EndRequest(IAsyncResult result) {
            lock (_asyncRequests) {
                ...
                // If not, finish it
                Message msg = _asyncRequests[result.AsyncWaitHandle].EndInvoke(result);
        ...
        public Message Request(Message message, TimeSpan timeout) {
            ...
            lock (_stateLock) {
                ...
                if (this.State == CommunicationState.Closing || this.State == CommunicationState.Closed)
                    if (_wasAborted) {
                        ...
                        throw new ObjectDisposedException("Rasp Email Request Channel");
                    }
            ...
            if (message.IsFault) {
                ...
                try {
                    ...
                    // TODO: Should we:  throw new CommunicationObjectAbortedException()?
                    ...
                    this.Fault();
                    message.Close();
                    throw new RaspEmailResponseNotGottenException(e);
                }
