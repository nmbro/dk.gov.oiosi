...
namespace dk.gov.oiosi.extension.wcf.EmailTransport {
    ...
    /// </summary>
    public class RaspEmailRequestContext: RequestContext {
        /// <summary>
        ...
        private RaspEmailBindingElement _bindingElement;
        ...
        public override void Reply(Message message) {
            // TODO: Is this the right check to do? Should we really just forget about the null?
            if (message == null) {
