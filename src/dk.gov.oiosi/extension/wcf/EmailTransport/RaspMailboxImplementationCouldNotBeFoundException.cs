...
namespace dk.gov.oiosi.extension.wcf.EmailTransport
{
    ...
    /// </summary>
    public class RaspMailboxImplementationCouldNotBeFoundException : RaspEmailTransportException {
        
        /// <summary>
        /// Constructor with keyword
        /// </summary>
        /// <param name="type">keyword for the message</param>
        public RaspMailboxImplementationCouldNotBeFoundException(string type) : base(GetKeywords(type)) { }
        ...
        public RaspMailboxImplementationCouldNotBeFoundException(string type, System.Exception innerException) : base(GetKeywords(type), innerException) { }
