...
namespace dk.gov.oiosi.extension.wcf.Interceptor.Validation.Certificate
{
    ...
    /// </summary>
    public class CertificateValidateDocumentFailedException : InterceptorChannelException {

        /// <summary>
        /// Constuctor with innerexception
        /// </summary>
        /// <param name="innerException">innerexception of the thrown exception</param>
        public CertificateValidateDocumentFailedException(System.Exception innerException) 
        ...
        private static OiosiFaultCode GetFaultCode(Exception innerException) 
        {
            ...
            if (type == typeof(FailedToGetCertificateSubjectException))
            {
        ...
        private static OiosiInnerFaultCode GetInnerFaultCode(Exception innerException)
        {
            ...
            if (type == typeof(FailedToGetCertificateSubjectException))
            {
                oiosiInnerFaultCode = OiosiInnerFaultCode.NotAuthorizedFault;
            }
