...
namespace dk.gov.oiosi.extension.wcf.Interceptor.Validation.Schematron {
    ...
    /// <summary>
    /// Binding element for the client schematron validation interceptor
    /// </summary>
    public class ClientSchematronValidationBindingElement : ValidationBindingElement {
        ...
        public ClientSchematronValidationBindingElement(ValidationConfiguration configuration) : base(configuration) {
        ...
        public override BindingElement Clone() {
            return new ClientSchematronValidationBindingElement(_configuration);
        }
