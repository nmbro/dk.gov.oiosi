...
namespace dk.gov.oiosi.extension.wcf.Interceptor.Validation {
    ...
    public abstract class ValidationBindingElement : BindingElement, IChannelInterceptor {
        ...
        /// <returns><![CDATA[
        /// true if the System.ServiceModel.Channels.IChannelFactory<TChannel> of type
        ...
        /// <returns><![CDATA[
        /// true if the System.ServiceModel.Channels.IChannelFactory<TChannel> of type
        /// TChannel can be built by the binding element; otherwise, false
        /// ]]></returns>
        ...
        /// </summary>
        public virtual bool DoesFaultOnRequestException {
            get { return false; }
        }
