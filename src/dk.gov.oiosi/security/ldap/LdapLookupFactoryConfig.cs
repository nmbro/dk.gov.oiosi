...
namespace dk.gov.oiosi.security.ldap {
    ...
    /// <summary>
    /// Configuration of the LdapLookupFactory class. 
    /// </summary>
    [System.Xml.Serialization.XmlRoot(Namespace = ConfigurationHandler.RaspNamespaceUrl)]
    public class LdapLookupFactoryConfig {
        private string _implementationNamespaceClass = "";

        /// <summary>
        /// The namespace and class of the OcspLookup implementation
        /// </summary>
        ...
        /// <summary>
        /// The namespace of the OcspLookup implementation
        /// </summary>
        ...
        /// Default constructor
        /// </summary>
        public LdapLookupFactoryConfig() {
        }
    }
}