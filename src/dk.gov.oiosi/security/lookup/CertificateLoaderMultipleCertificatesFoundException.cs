...
namespace dk.gov.oiosi.security.lookup {
    /// <summary>
    /// Exception thrown when the certificate loader find multiple certificates from a given
    /// critia.
    /// </summary>
    public class CertificateLoaderMultipleCertificatesFoundException : MultipleCertificatesFoundException {
        /// <summary>
        ...
        public CertificateLoaderMultipleCertificatesFoundException(X509Store store, X509FindType findType, string searchString)
