...
namespace dk.gov.oiosi.security.ocsp {
    ...
    /// </summary>
    public abstract class OcspException : MainException {
        private static ResourceManager resourceManager = new ResourceManager(typeof(ErrorMessages));

        /// <summary>
        /// Base constructor
        /// </summary>
        public OcspException() : base(resourceManager) { }
        
        /// <summary>
        /// Constructor with keywords
        /// </summary>
        /// <param name="keywords">keywords for the message</param>
        public OcspException(System.Collections.Generic.Dictionary<string, string> keywords) : base(resourceManager, keywords) { }
        
        /// <summary>
        /// Constructor with innerexception
        /// </summary>
        /// <param name="innerException">innerexception of the thrown exception</param>
        public OcspException(System.Exception innerException) : base(resourceManager, innerException) { }
    }
}