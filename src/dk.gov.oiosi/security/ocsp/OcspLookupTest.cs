...
namespace dk.gov.oiosi.security.ocsp {
    ...
    /// <summary>
    /// Implementation of the IOcspLookup interface for offline testing.
    /// You may configure the OcspLookupFactory to instantiate classes of this type.
    /// </summary>
    public class OcspLookupTest : IOcspLookup {
        private OcspConfig _config;
        private OcspLookupTestConfig _testConfig;


        #region IOcspLookup Members

        /// <summary>
        /// Returns the status of the certificate. In this offline test implementation of the
        /// IOcspLookup interface, the response can be set in the configuration file
        /// </summary>
