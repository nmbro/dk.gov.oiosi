...
namespace dk.gov.oiosi.security.revocation {
    ...
    public abstract class RevocationException : MainException {
        ...
        /// Base constructor
        /// </summary>
        public RevocationException() : base(resourceManager) { }
        
        /// <summary>
        /// Constructor with keywords
        /// </summary>
        /// <param name="keywords">keywords for the message</param>
        public RevocationException(System.Collections.Generic.Dictionary<string, string> keywords) : base(resourceManager, keywords) { }
        
        /// <summary>
        /// Constructor with innerexception
        /// </summary>
        /// <param name="innerException">innerexception of the thrown exception</param>
        public RevocationException(System.Exception innerException) : base(resourceManager, innerException) { }
    }
}