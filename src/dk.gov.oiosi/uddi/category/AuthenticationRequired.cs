...
namespace dk.gov.oiosi.uddi.category {
    ...
    /// <summary>
    /// Indicates if a service is publicly accessible or requires some form of authentication. 
    /// This is an OWSA 1.0 required field.
    /// </summary>
    public class AuthenticationRequired : ArsCategory {
        /// <summary>
        ...
        static AuthenticationRequired() {
            ...
            string[] values = { "http://oio.dk/profiles/OWSA/modelT/1.0/UDDI/authenticationRequired/",
                                "http://oio.dk/profiles/OWSA/modelT/1.0/UDDI/anonymousAccess/"
            };

            SetCategoryAndValues("http://oio.dk/profiles/OWSA/modelT/1.0/UDDI/Categories/AuthenticationRequirement/", values);
        }
        ...
        /// </summary>
        /// <param name="authentication">Authentication requirement</param>
        public AuthenticationRequired(AuthenticationRequiredCode authentication) {

            switch (authentication) {
                case AuthenticationRequiredCode.authenticationRequired:
                    pValue = "http://oio.dk/profiles/OWSA/modelT/1.0/UDDI/authenticationRequired/";
                    break;
                case AuthenticationRequiredCode.anonymousAccess:
                    pValue = "http://oio.dk/profiles/OWSA/modelT/1.0/UDDI/anonymousAccess/";
                    break;
                default:
                    pValue = "";
                    break;
