...
namespace dk.gov.oiosi.uddi.category {
    ...
    /// <summary>
    /// Date of expiration of the endpoint. Clients may use this information to cache endpoint addresses.
    /// Expiration date in UTC in the following format: "yyyy-MM-ddTHH:mm:ss.fffffffZ", e.g. "2006-08-02T11:05:00.0000000Z"
    /// </summary>
    public class EndpointExpirationDate : ArsCategory {
        ...
        static EndpointExpirationDate() {
            ...
            SetCategoryAndValues("http://oio.dk/profiles/OIOSI/1.0/UDDI/Categories/endpointExpirationDate/", values);
        }

        /// <summary>
        /// Default constructor. Sets to default.
        /// </summary>
        public EndpointExpirationDate() { }

        /// <summary>
        /// Use this constructor to set a value
        /// </summary>
        /// <param name="endpointExpirationDate">endpoint expiration date; "yyyy-MM-ddTHH:mm:ss.fffffffZ"
        /// If a local date is used here, it is converted to UTC</param>
        public EndpointExpirationDate(DateTime endpointExpirationDate) {

            try {
                DateTime tmpTime = endpointExpirationDate;
