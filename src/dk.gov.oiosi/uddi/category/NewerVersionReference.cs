...
namespace dk.gov.oiosi.uddi.category {
    ...
    /// <summary>
    /// Contains a link to the serviceKey of a newer version of the service, if one exists.
    /// </summary>
    public class NewerVersionReference : ArsCategory {
        ...
        static NewerVersionReference() {
            ...
            SetCategoryAndValues("http://oio.dk/profiles/OWSA/modelT/1.0/UDDI/Categories/newerVersionReference/", values);
        }

        /// <summary>
        /// Default constructor. Sets to default.
        /// </summary>
        public NewerVersionReference() { }

        /// <summary>
        /// Use this constructor to set a value
        /// </summary>
        /// <param name="newerVersionReference">a reference to a newer version of the service</param>
        public NewerVersionReference(UddiId newerVersionReference) {            
            pValue = newerVersionReference.ID;
        }
