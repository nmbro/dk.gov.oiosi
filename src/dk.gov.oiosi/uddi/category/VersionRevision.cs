...
namespace dk.gov.oiosi.uddi.category {
    ...
    /// <summary>
    /// Revision version number of the web service. This field MUST NOT be empty. 
    /// A positive 32-bit integer.
    /// Example: "0" or "8"
    /// </summary>
    public class VersionRevision : ArsCategory {

        /// <summary>
        /// Static constructor. Sets list of categories and possible values for each.
        /// </summary>
        static VersionRevision() {
            // 1. Set baseclass default values:
            _categoryId = IdentifierUtility.GetUddiIDFromString("uddi:8e7ce808-0279-4042-8088-133667744c6f");
            _categoryName = "http://oio.dk/profiles/OWSA/modelT/1.0/UDDI/Categories/serviceVersionRevision/";
            _defaultKeyName = "http://oio.dk/profiles/OWSA/modelT/1.0/UDDI/Categories/serviceVersionRevision/";
            _defaultKeyValue = "0";

            string[] values = { };

            SetCategoryAndValues("http://oio.dk/profiles/OWSA/modelT/1.0/UDDI/Categories/serviceVersionRevision/", values);
        }
        ...
        /// </summary>
        /// <param name="versionRevision">revision version</param>
        public VersionRevision(string versionRevision) {
            pValue = versionRevision;
        }
