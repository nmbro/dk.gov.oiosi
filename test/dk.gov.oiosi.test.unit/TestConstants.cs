namespace dk.gov.oiosi.test.unit {
    public class TestConstants {
        ...
        public const string PATH_CATALOGUEPRICINGUPDATE_XML = raspProfileResources + "Documents/Examples/OIOUBL_CataloguePricingUpdate_v2p2.xml";
        ...
        public const string PATH_INVOICEWRONGELEMENT_XML = raspProfileResources + "Documents/Examples Invalid/OIOUBL_Invoice_v2p1_WrongElement.xml";
        public const string PATH_INVOICEWRONGNAMESPACE_XML = raspProfileResources + "Documents/Examples Invalid/OIOUBL_Invoice_v2p1_WrongNamespace.xml";
        public const string PATH_INVOICENOID_XML = raspProfileResources + "Documents/Examples Invalid/OIOUBL_Invoice_v2p1_NoId.xml";
        public const string PATH_INVOICEN7INVALIDEANNUMBER_XML = raspProfileResources + "Documents/Examples Invalid/OIOXML_Invoice_Invalid_EanNumber_v0.7.xml";
        public const string PATH_ORDER_XML = raspProfileResources + "Documents/Examples/OIOUBL_Order_v2p2.xml";
        public const string PATH_ORDERCANCELLATION_XML = raspProfileResources + "Documents/Examples/OIOUBL_OrderCancellation_v2p2.xml";
        public const string PATH_ORDERCHANGE_XML = raspProfileResources + "Documents/Examples/OIOUBL_OrderChange_v2p2.xml";
        public const string PATH_ORDERRESPONSE_XML = raspProfileResources + "Documents/Examples/OIOUBL_OrderResponse_v2p2.xml";
        public const string PATH_ORDERRESPONSESIMPLE_XML = raspProfileResources + "Documents/Examples/OIOUBL_OrderResponseSimple_v2p2.xml";
        ...
        public const string PATH_INVOICE_XML_IDENTIFIER_EAN = raspProfileResources + "Documents/IdentifierExamples/OIOUBL_Invoice_identifier_ean_v2p1.xml";
        public const string PATH_INVOICE_XML_IDENTIFIER_OVT = raspProfileResources + "Documents/IdentifierExamples/OIOUBL_Invoice_identifier_ovt_v2p1.xml";
        public const string PATH_INVOICE_XML_IDENTIFIER_CVR = raspProfileResources + "Documents/IdentifierExamples/OIOUBL_Invoice_identifier_cvr_v2p1.xml";
        public const string PATH_INVOICE_XML_IDENTIFIER_P = raspProfileResources + "Documents/IdentifierExamples/OIOUBL_Invoice_identifier_p_v2p1.xml";
        public const string PATH_INVOICE_XML_IDENTIFIER_SE = raspProfileResources + "Documents/IdentifierExamples/OIOUBL_Invoice_identifier_se_v2p1.xml";
        public const string PATH_INVOICE_XML_IDENTIFIER_VANS = raspProfileResources + "Documents/IdentifierExamples/OIOUBL_Invoice_identifier_vans_v2p1.xml";
        public const string PATH_INVOICE_XML_IDENTIFIER_IBAN = raspProfileResources + "Documents/IdentifierExamples/OIOUBL_Invoice_identifier_iban_v2p1.xml";
        public const string PATH_INVOICE_XML_IDENTIFIER_DUNS = raspProfileResources + "Documents/IdentifierExamples/OIOUBL_Invoice_identifier_duns_v2p1.xml";
